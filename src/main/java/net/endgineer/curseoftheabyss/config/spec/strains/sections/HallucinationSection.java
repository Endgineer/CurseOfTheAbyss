...
public class HallucinationSection {
    ...
    public HallucinationSection(ForgeConfigSpec.Builder builder) {
        ...
        LAYER1_RANGE = builder.comment(
            "The range which defines the approximate amount of sanity drained every tick per block ascended in the 1st layer.\n"+
        ...
        LAYER2_RANGE = builder.comment(
            "The range which defines the approximate amount of sanity drained every tick per block ascended in the 2nd layer.\n"+
            "Values: {\"[m, M]\" | 0 <= m <= M <= "+Double.MAX_VALUE+"}\n"+
        ...
        LAYER3_RANGE = builder.comment(
            "The range which defines the approximate amount of sanity drained every tick per block ascended in the 3rd layer.\n"+
            "Values: {\"[m, M]\" | 0 <= m <= M <= "+Double.MAX_VALUE+"}\n"+
        ...
        LAYER4_RANGE = builder.comment(
            "The range which defines the approximate amount of sanity drained every tick per block ascended in the 4th layer.\n"+
            "Values: {\"[m, M]\" | 0 <= m <= M <= "+Double.MAX_VALUE+"}\n"+
        ...
        LAYER5_RANGE = builder.comment(
            "The range which defines the approximate amount of sanity drained every tick per block ascended in the 5th layer.\n"+
            "Values: {\"[m, M]\" | 0 <= m <= M <= "+Double.MAX_VALUE+"}\n"+
        ...
        LAYER6_RANGE = builder.comment(
            "The range which defines the approximate amount of sanity drained every tick per block ascended in the 6th layer.\n"+
            "Values: {\"[m, M]\" | 0 <= m <= M <= "+Double.MAX_VALUE+"}\n"+
        ...
        LAYER7_RANGE = builder.comment(
            "The range which defines the approximate amount of sanity drained every tick per block ascended in the 7th layer.\n"+
            "Values: {\"[m, M]\" | 0 <= m <= M <= "+Double.MAX_VALUE+"}\n"+
